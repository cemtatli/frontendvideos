    ...
    >
      ...
      >
        <path
          ...
          fill="url(#9089FC-16c6-4eb9-931b-8e24bf34e053)"
          fillOpacity=".3"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-zinc-900">
          ...
          Junior Frontend developerların sektöre giriş aşamasında yardımcı olabilecek yararlı ve öğretici YouTube
          videolarını sunmaktadır.
        </p>
        <a
          target="_blank"
          href="https://github.com/cemtatli/frontendvideos"
          className="flex-none rounded-full bg-zinc-900 px-4 py-1 text-sm font-semibold text-white shadow-sm hover:bg-zinc-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900"
        >
          Katkıda bulun
        </a>
      </div>
      <div className="flex flex-1 justify-end">
        <a id="banner-button" className="-m-3 cursor-pointer p-3 focus-visible:outline-offset-[-4px] ">
          <X
            onClick={closeHandle}
            className="text-zinc-800 transition-all hover:scale-125 hover:text-zinc-950"
            width={16}
            height={16}
          />
        </a>
