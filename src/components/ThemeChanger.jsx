...
export default function ThemeChanger() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-5 w-10 items-center justify-center rounded-full bg-gray-200 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white "
    >
      <span
